...
// -------- SAIDAS PAR E IMPAR --------
// 		  a operação que escreve todos pares em um canal de saidaPares e
//        todos impares em um canal saidaImpares, e ao final avisa que acabou em um canal fin
// Sequencial
...
func main() {
	...
	fmt.Println()
	go buscaConc(root, 17, ret)
	fmt.Println("Busca Concorrente 17: ", <-ret)

	go buscaConc(root, 99, ret)
	fmt.Println("Busca Concorrente 99: ", <-ret)
}
